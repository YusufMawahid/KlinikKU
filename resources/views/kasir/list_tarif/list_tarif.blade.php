        ...
        <div class="page-title">
          ...
          <div class="page-title">
            <div class="title_left">
              <a href="{{ url('list_obat')}}"><h3>LIST TARIF</h3></a>
            </div>

            <div class="title_right">
              <div class="col-md-6 col-sm-5 col-xs-16 form-group pull-right top_search">
                <div class="input-group">
                      <input type="text" class="form-control" name="search" placeholder="Berdasarkan Nama Tarif ">    
              ...
              <div class="x_title">
                ...
                <div class="x_content">
                  <table class="table table-hover">
					...
					<?php $i = 1; ?>
                  	@foreach ($list_tarif as $key => $data)
                    <tbody>
                      <tr>
